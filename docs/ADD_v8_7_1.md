...
gantt
    ...
    section strict-PIT warmup (排除验收)
    segment B : 2012-01-06, 2014-11-21
    section strict-PIT (验收唯一依据)
    segment C : 2014-11-28, 2026-04-17
    section 训练下限
...
**签名稳定性**：以上签名在 v8.7.1 生命周期内禁止破坏性变更；新增参数必须有默认值且不影响返回形状。
